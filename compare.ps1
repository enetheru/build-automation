...
"grepping for all compile_commands inside '$args' and running compare on them."

$files = (rg --files $args | rg compile_commands.json) -join ' '
python .\share\compare_flags.py $files